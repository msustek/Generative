...
import pickle
from exp_repair_definition import repair_experiment
                        ...
                        for vde in[1,2]:
                            ...
                            for vdd in [1,2]:
                                ...
                                for model_t in [True, False]:
                                    ...
                                    repair_experiment(conf, modify_during_training, f'{DS_TYPE[:3]}{conf["TRAIN_DATA_C"]}_{update_type}_OPT={opt_type}_SCE={b(sce)}_SCD={b(scd)}_VDE={vde}_VDD={vdd}', data, toy_data_introspect = True, script_path = os.path.abspath(__file__), save_results_cond = save_results_cond)
                                    #exit()
